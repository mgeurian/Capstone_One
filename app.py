...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'postgresql:///db_educryption').replace("postgres://", "postgresql://", 1)

# if app.config['SQLALCHEMY_DATABASE_URI'].startswith("postgres://"):
#     app.config['SQLALCHEMY_DATABASE_URI'] = app.config['SQLALCHEMY_DATABASE_URI'].replace("postgres://", "postgresql://", 1)

# app.config["SQLALCHEMY_DATABASE_URI"] = os.environ.get('DATABASE_URL', "postgres:///").replace("://", "ql://", 1)
